...
namespace Microsoft.Azure.IIoT.Services.OpcUa.Twin.History.Controllers {
    ...
    public class HistoryController : ControllerBase {
        ...
        public async Task<HistoryReadResponseApiModel<IValue>> HistoryReadRawAsync(
            string endpointId, [FromBody] [Required] HistoryReadRequestApiModel<IValue> request) {
            if (request == null) {
        ...
        public async Task<HistoryReadNextResponseApiModel<IValue>> HistoryReadRawNextAsync(
        ...
        public async Task<HistoryUpdateResponseApiModel> HistoryUpdateRawAsync(
            string endpointId, [FromBody] [Required] HistoryUpdateRequestApiModel<IValue> request) {
            if (request == null) {
                throw new ArgumentNullException(nameof(request));
            }
